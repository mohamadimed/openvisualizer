...
class Neighbors(View):
    ...
    def render(self, ms=None):
        ...
        addr_headers, stable_neighbor, join_prio, cellRadioSetting = [], [], [], []
        ...
        for neighbor in neighbor_rows:
            ...
            cellRadioSetting.append('|{:^13s}'.format(str((neighbor['cellRadioSetting']))))
        ...
        neighbor_info['cellRadioSetting '] = ''.join(cellRadioSetting) + '|'
