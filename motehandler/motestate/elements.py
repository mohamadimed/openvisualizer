...
class StateScheduleRow(StateElem):
    def update(self, notif=None, creator=None, owner=None):
        ...
        self.data[0]['cellRadioSetting']    = networkInfo.radioSettingAbbreviationMap[notif.cellRadioSetting]#radioSettingMap
...
class StateQueueRow(StateElem):
    def update(self, notif=None, creator=None, owner=None, cellRadioSetting=None, addr_type=None, addr_bodyH=None, addr_bodyL=None):
        ...
        if 'cellRadioSetting' not in self.data[0]:
            self.data[0]['cellRadioSetting']           = cellRadioSetting
        #if 'addr' not in self.data[0]:
         #   self.data[0]['addr'] = TypeAddr()
        #self.data[0]['addr'].update(addr_type,
         #                          addr_bodyH,
          #                         addr_bodyL)
...
class StateQueue(StateElem):
    ...
    def update(self, notif=None, creator=None, owner=None, cellRadioSetting=None, addr_type=None, addr_bodyH=None, addr_bodyL=None):
        ...
        self.data[0].update(notif.creator_0,notif.owner_0,   notif.cellRadioSetting_0 , notif.addr_type_0 ,notif.addr_bodyH_0 ,notif.addr_bodyL_0  )
        self.data[1].update(notif.creator_1,notif.owner_1,   notif.cellRadioSetting_1 , notif.addr_type_1 ,notif.addr_bodyH_1 ,notif.addr_bodyL_1  )
        self.data[2].update(notif.creator_2,notif.owner_2,   notif.cellRadioSetting_2 , notif.addr_type_2 ,notif.addr_bodyH_2 ,notif.addr_bodyL_2  )
        self.data[3].update(notif.creator_3,notif.owner_3,   notif.cellRadioSetting_3 , notif.addr_type_3 ,notif.addr_bodyH_3 ,notif.addr_bodyL_3  )
        self.data[4].update(notif.creator_4,notif.owner_4,   notif.cellRadioSetting_4 , notif.addr_type_4 ,notif.addr_bodyH_4 ,notif.addr_bodyL_4  )
        self.data[5].update(notif.creator_5,notif.owner_5,   notif.cellRadioSetting_5 , notif.addr_type_5 ,notif.addr_bodyH_5 ,notif.addr_bodyL_5  )
        self.data[6].update(notif.creator_6,notif.owner_6,   notif.cellRadioSetting_6 , notif.addr_type_6 ,notif.addr_bodyH_6 ,notif.addr_bodyL_6  )
        self.data[7].update(notif.creator_7,notif.owner_7,   notif.cellRadioSetting_7 , notif.addr_type_7 ,notif.addr_bodyH_7 ,notif.addr_bodyL_7  )
        self.data[8].update(notif.creator_8,notif.owner_8,   notif.cellRadioSetting_8 , notif.addr_type_8 ,notif.addr_bodyH_8 ,notif.addr_bodyL_8  )
        self.data[9].update(notif.creator_9,notif.owner_9,   notif.cellRadioSetting_9 , notif.addr_type_9 ,notif.addr_bodyH_9 ,notif.addr_bodyL_9  )
